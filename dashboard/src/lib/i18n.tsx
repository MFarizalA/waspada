...
const EN: Dict = {
  ...
  "oh.title": "Origination Health",
  "oh.approvalRate": "Approval rate",
  "oh.projectedDefault": "Projected default (approved book)",
  "oh.approvedVolume": "Approved volume",
  "oh.bandMix": "Application band mix",
  ...
  "ad.watchDebate": "▶ Watch the debate",
  "ad.controlsLabel": "Debate playback controls",
  "ad.play": "▶ Play",
  "ad.pause": "❚❚ Pause",
  "ad.step": "⏭ Step",
  "ad.replay": "↺ Replay",
  "ad.speedLabel": "Reveal speed",
  "ad.speedNormal": "Normal",
  "ad.speedSlow": "Slow",
  "ad.thinking": "{speaker} is thinking…",
  "flow.deliberating": "Deliberating…",
  "ad.debatingBody": "The Risk Auditor, Actuary, and Credit Arbiter are debating the riskiest accounts over Qwen…",
  "flow.convening": "The society is convening — the debate reveals below, turn by turn.",
  "flow.idle": "The society is standing by. Press Watch the debate to see it reason, turn by turn.",
  ...
  "mc.title": "Model card",
  "mc.modelId": "The exact model version that scored this run (WA-082)",
  "pm.title": "Parameter matrix",
  "pm.subtitle": "Set the policy the society plays by, then run",
  "pm.grid": "Risk band to collections action",
  "pm.disputeGap": "Dispute gap",
  "pm.arbiterConf": "Arbiter confidence",
  "pm.auditK": "Audit K",
  "pm.topN": "Work-list cap",
  "pm.npl": "NPL alert",
  "pm.vintage": "Vintage alert",
  "pm.run": "Run with this matrix",
  "pm.running": "Running…",
  "pm.applied": "Applied {id} · {accounts} accounts · {disputes} disputes",
...
const ZH: Dict = {
  ...
  "oh.title": "进件健康度",
  "oh.approvalRate": "批准率",
  "oh.projectedDefault": "预计违约率（已批准）",
  "oh.approvedVolume": "批准金额",
  "oh.bandMix": "申请评级分布",
  ...
  "ad.speedNormal": "正常",
  "ad.speedSlow": "缓慢",
  "ad.thinking": "{speaker} 正在思考…",
  "flow.deliberating": "裁决中…",
  "ad.debatingBody": "风险审计员、精算师与信贷仲裁者正在通过 Qwen 就最高风险账户展开辩论…",
  "flow.convening": "智能体社会正在集结——辩论将在下方逐条呈现。",
  "flow.idle": "智能体社会待命中。点击“观看辩论”，逐条见证其推理过程。",
  ...
  "esc.jump": "查看辩论 →",
  "mc.title": "模型卡",
  "mc.modelId": "为本次运行评分的确切模型版本（WA-082）",
  "pm.title": "参数矩阵",
  "pm.subtitle": "设定智能体社会遵循的策略，然后运行",
  "pm.grid": "风险评级对应催收动作",
  "pm.disputeGap": "争议阈值",
  "pm.arbiterConf": "仲裁置信度",
  "pm.auditK": "审计数 K",
  "pm.topN": "工作列表上限",
  "pm.npl": "不良率告警",
  "pm.vintage": "账龄告警",
  "pm.run": "以此矩阵运行",
  "pm.running": "运行中…",
  "pm.applied": "已应用 {id} · {accounts} 个账户 · {disputes} 项争议",
  "mc.calibrated": "已校准",
  "mc.uncalibrated": "未校准",
